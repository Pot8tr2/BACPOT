...
extern uint8_t TXBUFFER2[BUFFER_SIZE];
extern uint8_t RXBUFFER2[BUFFER_SIZE];
extern volatile int len_string; 
extern volatile  int rx_int;
extern volatile  int tx_int;
extern volatile  int rx_int2;
extern volatile  int tx_int2;
extern volatile int len_string2; 
